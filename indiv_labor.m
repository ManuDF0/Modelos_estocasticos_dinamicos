...
figure(1)
subplot(2,1,1)
impulse_response(P,Q,R,S,N, 50, 1, [1; 4; 5; 6; 7; 8; 10; 11]);
title('Real Variables')
legend('k', 'c', 'w', 'h', 'r', 'y', 'rn', 'rf')

subplot(2,1,2)
impulse_response(P,Q,R,S,N, 50, 1, [2; 3; 9]);
...
figure(2)
subplot(2,1,1)
impulse_response(P,Q,R,S,N, 50, 2, [1; 4; 5; 6; 7; 8; 10; 11]);
title('Real Variables')
legend('k', 'c', 'w', 'h', 'r', 'y', 'rn', 'rf')

subplot(2,1,2)
impulse_response(P,Q,R,S,N, 50, 2, [2; 3; 9]);
title('Nominal Variables')
legend('M', 'P', 'N')
