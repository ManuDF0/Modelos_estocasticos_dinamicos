function f = system_of_equations(x)
    ...
    global alpha delta gamma beta theta B;
    ...
    f(7) = w*h + r*k - delta * k + r_n * n - m;
    f(8) = w*h - l;
    f(9) = l - theta*n;
    f(10) = c - m + n;
    f(11) = r_f*l +(1 - theta)*n - r_n*n;
endfunction

// Definición de parámetros globales
global alpha delta beta theta B;
// Seteo un valor
alpha = 0.36;  
delta = 0.025;   
beta = 0.99;
...
x0 = [0.035101, 1.010101, 1.010101, 2.3469, 0.1, 0.32688, 1.2108, 12.418, 0.9, 1.6675, 0.76715];
